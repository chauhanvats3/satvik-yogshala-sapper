...
<footer>
    <div class="categories">
        <div class="category">
            ...
            <div class="content">
                <p><a href="yoga-retreat#body">Yoga Retreat</a></p>
                <p><a href="teacher-training/100-hour-ytt#body">100 Hours YTT</a></p>
                <p><a href="teacher-training/200-hour-ytt#body">200 Hours YTT</a></p>
                <p><a href="teacher-training/200-hour-multistyle-ytt#body">200 Hours Multistyle YTT</a></p>
            </div>
        </div>
        <div class="category faq">
            <div class="heading"><a href="about/faq#body">FAQ</a></div>
            <div class="heading"><a href="about/gallery#body">GALLERY</a></div>
            <div class="heading"><a href="blog#body">BLOG</a></div>
        </div>
        <div class="category">
    ...
    <div class="banner">
        <div>Copyright © {year} <a href=".#body" class="link"> Satvik Yogshala. </a>
